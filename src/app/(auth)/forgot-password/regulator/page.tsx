...
const forgotPasswordSchema = z.object({
  email: z.string().email("Format email instansi tidak valid"),
});

type ForgotPasswordForm = z.infer<typeof forgotPasswordSchema>;

export default function RegulatorForgotPasswordPage() {
  ...
  const onSubmit = async (data: ForgotPasswordForm) => {
    console.log("Mengirim tautan reset Regulator ke:", data.email);
          ...
          {isSubmitted ? (
            <div className="text-center space-y-4 py-8">
              ...
              <p className="text-muted-foreground">
                Tautan reset password untuk akun Regulator Anda telah dikirim ke{" "}
            ...
            <>
              <div className="text-center space-y-2">
                ...
                <h2 className="text-3xl font-bold text-foreground">
                  Lupa Password Regulator
                </h2>
                <p className="text-muted-foreground">
                  Masukkan email akun instansi Anda untuk mengatur ulang
                  password.
                </p>
              </div>
