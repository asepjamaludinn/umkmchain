        ...
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)]">
          ...
          <div className="grid md:grid-cols-2 gap-8 w-full max-w-2xl">
            ...
            <Link href="/signup/umkm">
              <div className="group h-full bg-card rounded-3xl border-2 border-border shadow-lg hover:shadow-2xl hover:border-secondary transition-all duration-300 p-8 cursor-pointer">
